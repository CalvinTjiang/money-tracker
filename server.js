...
mongoose.connect('mongodb://localhost:27017/money-tracker-react', {useNewUrlParser: true }, function (err) {
    if (err) {
...
//Note 
// Add Purchase RESTFul endpoints with only option which attribute to be populated
// Purchase RESTFul endpoints 
